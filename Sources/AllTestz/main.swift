...
final class ObservableMergeTest_ : ObservableMergeTest, RxTestCase {
    ...
    ("testConcatMap_Complete_Complete", ObservableMergeTest.testConcatMap_Complete_Complete),
    ("testConcatMap_Never_Complete", ObservableMergeTest.testConcatMap_Never_Complete),
    ("testConcatMap_Complete_Never", ObservableMergeTest.testConcatMap_Complete_Never),
    ("testConcatMap_Complete_Error", ObservableMergeTest.testConcatMap_Complete_Error),
    ("testConcatMap_Error_Complete", ObservableMergeTest.testConcatMap_Error_Complete),
    ("testConcatMap_Error_Error", ObservableMergeTest.testConcatMap_Error_Error),
    ("testConcatMap_Complete", ObservableMergeTest.testConcatMap_Complete),
    ("testConcatMap_Complete_InnerNotComplete", ObservableMergeTest.testConcatMap_Complete_InnerNotComplete),
    ("test_Complete_OuterNotComplete", ObservableMergeTest.test_Complete_OuterNotComplete),
