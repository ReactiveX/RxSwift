...
final class ObservableTimeTest_ : ObservableTimeTest, RxTestCase {
    ...
    ("testIgnoreElementsResourcesOnComplete", ObservableTimeTest.testIgnoreElementsResourcesOnComplete),
    ("testIgnoreElementsResourcesOnError", ObservableTimeTest.testIgnoreElementsResourcesOnError),
