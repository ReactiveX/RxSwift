...
_ObservableStandardSequenceOperatorsTest.allTests = [
    ...
    ("testConcatMap_Complete", { _ObservableStandardSequenceOperatorsTest.setUp(); _ObservableStandardSequenceOperatorsTest.testConcatMap_Complete(); _ObservableStandardSequenceOperatorsTest.tearDown(); }),
    ("testConcatMap_Complete_InnerNotComplete", { _ObservableStandardSequenceOperatorsTest.setUp(); _ObservableStandardSequenceOperatorsTest.testConcatMap_Complete_InnerNotComplete(); _ObservableStandardSequenceOperatorsTest.tearDown(); }),
    ("testConcatMap_Complete_OuterNotComplete", { _ObservableStandardSequenceOperatorsTest.setUp(); _ObservableStandardSequenceOperatorsTest.testConcatMap_Complete_OuterNotComplete(); _ObservableStandardSequenceOperatorsTest.tearDown(); }),
    //("testConcatMap_Complete_ErrorOuter", { _ObservableStandardSequenceOperatorsTest.setUp(); _ObservableStandardSequenceOperatorsTest.testConcatMap_Complete_ErrorOuter(); _ObservableStandardSequenceOperatorsTest.tearDown(); }),
    //("testConcatMap_Error_Inner", { _ObservableStandardSequenceOperatorsTest.setUp(); _ObservableStandardSequenceOperatorsTest.testConcatMap_Error_Inner(); _ObservableStandardSequenceOperatorsTest.tearDown(); }),
    ("testConcatMap_Dispose", { _ObservableStandardSequenceOperatorsTest.setUp(); _ObservableStandardSequenceOperatorsTest.testConcatMap_Dispose(); _ObservableStandardSequenceOperatorsTest.tearDown(); }),
    //("testConcatMap_SelectorThrows", { _ObservableStandardSequenceOperatorsTest.setUp(); _ObservableStandardSequenceOperatorsTest.testConcatMap_SelectorThrows(); _ObservableStandardSequenceOperatorsTest.tearDown(); }),
    ("testConcatMap_UseFunction", { _ObservableStandardSequenceOperatorsTest.setUp(); _ObservableStandardSequenceOperatorsTest.testConcatMap_UseFunction(); _ObservableStandardSequenceOperatorsTest.tearDown(); }),
