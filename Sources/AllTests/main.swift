...
_ObservableSingleTest.allTests = [
    ...
    ("testDoOnSubscribe_normal", { _ObservableSingleTest.setUp(); _ObservableSingleTest.testDoOnSubscribe_normal(); _ObservableSingleTest.tearDown(); }),
    //("testDoOnSubscribe_throws", { _ObservableSingleTest.setUp(); _ObservableSingleTest.testDoOnSubscribe_throws(); _ObservableSingleTest.tearDown(); }),
    ("testDoOnUnsubscribe_normal", { _ObservableSingleTest.setUp(); _ObservableSingleTest.testDoOnUnsubscribe_normal(); _ObservableSingleTest.tearDown(); }),
    //("testDoOnUnsubscribe_throws", { _ObservableSingleTest.setUp(); _ObservableSingleTest.testDoOnUnsubscribe_throws(); _ObservableSingleTest.tearDown(); }),
