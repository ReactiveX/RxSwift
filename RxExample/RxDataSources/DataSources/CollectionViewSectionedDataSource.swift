...
open class CollectionViewSectionedDataSource<S: SectionModelType>
    ...
    public override init() {
        ...
        self.configureCell = { [weak self] (_: CollectionViewSectionedDataSource<S>, _: UICollectionView, _: IndexPath, _: I) in
        ...
        self.supplementaryViewFactory = { [weak self] (_: CollectionViewSectionedDataSource<S>, _: UICollectionView, _: String, _: IndexPath) in
