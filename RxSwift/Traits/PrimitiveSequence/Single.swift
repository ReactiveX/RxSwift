...
extension PrimitiveSequenceType where Trait == SingleTrait {
    public typealias SingleObserver = @Sendable (SingleEvent<Element>) -> Void
     ...
     */
    public static func create(subscribe: @escaping @Sendable (@escaping @Sendable SingleObserver) -> Disposable) -> Single<Element> {
     ...
     */
    public func subscribe(_ observer: @escaping @Sendable (SingleEvent<Element>) -> Void) -> Disposable {
    ...
    public func subscribe(onSuccess: (@Sendable (Element) -> Void)? = nil,
                          onError: @escaping (@Sendable (Swift.Error) -> Void),
...
extension PrimitiveSequenceType where Trait == SingleTrait {
     ...
     */
    public func `do`(onSuccess: (@Sendable (Element) throws -> Void)? = nil,
     ...
     */
    public func flatMap<Result>(_ selector: @escaping @Sendable (Element) throws -> Single<Result>)
        -> Single<Result> {
    ...
    /**
     ...
     - returns: An observable sequence whose elements are the result of invoking the one-to-many transform function on each element of the input sequence.
     */
    public func flatMapMaybe<Result>(_ selector: @escaping @Sendable (Element) throws -> Maybe<Result>)
        -> Maybe<Result> {
    ...
    /**
     ...
     - returns: An observable sequence whose elements are the result of invoking the one-to-many transform function on each element of the input sequence.
     */
    public func flatMapCompletable(_ selector: @escaping @Sendable (Element) throws -> Completable)
        -> Completable {
     ...
     */
    public static func zip<Collection: Swift.Collection, Result>(_ collection: Collection, resultSelector: @escaping @Sendable ([Element]) throws -> Result) -> PrimitiveSequence<Trait, Result> where Collection.Element == PrimitiveSequence<Trait, Element> {
