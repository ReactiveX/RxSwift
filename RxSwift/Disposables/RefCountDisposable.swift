...
public final class RefCountDisposable : DisposeBase, Cancelable, @unchecked Sendable {
...
internal final class RefCountInnerDisposable: DisposeBase, Disposable, @unchecked Sendable
{
