...
class AmbObserver<ElementType, O: ObserverType where O.Element == ElementType> : ObserverType {
...
class AmbSink<ElementType, O: ObserverType where O.Element == ElementType> : Sink<O> {
