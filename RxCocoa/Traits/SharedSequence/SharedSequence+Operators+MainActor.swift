...
// MARK: map
extension SharedSequenceConvertibleType where SharingStrategy: MainActorSharingStrategyProtocol {
...
// MARK: switchLatest
extension SharedSequenceConvertibleType where Element: SharedSequenceConvertibleType, SharingStrategy: MainActorSharingStrategyProtocol {
...
extension SharedSequenceConvertibleType where Element: Equatable, SharingStrategy: MainActorSharingStrategyProtocol {
...
extension SharedSequence where SharingStrategy: MainActorSharingStrategyProtocol {
    /**
