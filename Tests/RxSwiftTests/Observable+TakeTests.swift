...
extension ObservableTakeTest {
    ...
    func testTake_TakeZero() {
        ...
        let res = scheduler.start {
            xs.take(duration: 0, scheduler: scheduler)
        }
    ...
    func testTake_Some() {
        ...
        let res = scheduler.start {
            xs.take(duration: 25, scheduler: scheduler)
        }
    ...
    func testTake_TakeLate() {
        ...
        let res = scheduler.start {
            xs.take(duration: 50, scheduler: scheduler)
        }
    ...
    func testTake_TakeTwice1() {
        ...
        let res = scheduler.start {
            xs.take(duration: 55, scheduler: scheduler)
              .take(duration: 35, scheduler: scheduler)
        }
    ...
    func testTake_TakeDefault() {
        ...
        let res = scheduler.start {
            xs.take(duration: 35, scheduler: scheduler)
        }
        ...
        func testTakeTimeReleasesResourcesOnComplete() {
            let scheduler = TestScheduler(initialClock: 0)
            _ = Observable<Int>.just(1).take(duration: 35, scheduler: scheduler).subscribe()
            scheduler.start()
        }

        func testTakeTimeReleasesResourcesOnError() {
            let scheduler = TestScheduler(initialClock: 0)
            _ = Observable<Int>.error(testError).take(duration: 35, scheduler: scheduler).subscribe()
            scheduler.start()
        }
    #endif
}
