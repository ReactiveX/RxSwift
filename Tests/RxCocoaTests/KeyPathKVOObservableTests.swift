//
//  KeyPathKVOObservableTests.swift
//  Tests
//
...
final class KeyPathKVOObservableTests : RxTest {
}
...
private final class Parent : NSObject {
...
private final class Child : NSObject {
...
private final class ParentWithChild : NSObject {
    @objc dynamic var val: String = ""
...
@objc private enum IntEnum: Int {
    typealias RawValue = Int
    case one
    case two
}

@objc private enum UIntEnum: UInt {
    case one
    case two
}

@objc private enum Int32Enum: Int32 {
    case one
    case two
}

@objc private enum UInt32Enum: UInt32 {
    case one
    case two
}

@objc private enum Int64Enum: Int64 {
    case one
    case two
}

@objc private enum UInt64Enum: UInt64 {
    case one
    case two
}

private final class HasStrongProperty : NSObject {
    @objc dynamic var property: NSObject? = nil
    @objc dynamic var string: NSString? = nil
    @objc dynamic var hasStrongProperty: HasStrongProperty? = nil
    @objc dynamic var hasWeakProperty: HasWeakProperty? = nil
...
private final class HasWeakProperty : NSObject {
    @objc dynamic weak var property: NSObject? = nil
    @objc dynamic weak var string: NSString? = nil
    @objc dynamic weak var hasStrongProperty: HasStrongProperty? = nil
    @objc dynamic weak var hasWeakProperty: HasWeakProperty? = nil
...
extension KeyPathKVOObservableTests {
    func test_New() {
...
extension KeyPathKVOObservableTests {
    ...
    func testObserveWeak_SimpleStrongProperty() {
        ...
        _ = root.rx.observeWeakly(\.string)
    ...
    func testObserveWeak_ObserveFirst_Weak_Strong_Basic() {
        ...
        _ = root.rx.observeWeakly(\.hasStrongProperty, \.string)
            .subscribe(onNext: { n in
                latest = n as String?
            })
    ...
    func testObserveWeak_ObserveFirst_Strong_Weak_Basic() {
        ...
        _ = root.rx.observeWeakly(\.hasWeakProperty, \.string)
            .subscribe(onNext: { n in
                latest = n as String?
        })
    ...
    fileprivate func _testObserveWeak_Strong_Weak_Observe_NilLastPropertyBecauseOfWeak() -> (HasWeakProperty, NSObject?, Observable<Void>) {
        ...
        autoreleasepool {
            ...
            let observable = root.rx.observeWeakly(\.hasWeakProperty, \.property)
            _ = observable
                .subscribe(onNext: { n in
                    latest = n
                })
    ...
    fileprivate func _testObserveWeak_Weak_Weak_Weak_middle_NilifyCorrectly() -> (HasWeakProperty, NSObject?, Observable<Void>) {
        var dealloc: Observable<Void>! = nil
        ...
        autoreleasepool {
            ...
            root.hasWeakProperty = middle
            middle.hasWeakProperty = leaf

            XCTAssertTrue(latest == nil)

            let observable = root.rx.observeWeakly(\.hasWeakProperty, \.hasWeakProperty, \.property)
            _ = observable
                .subscribe(onNext: { n in
                    latest = n
                })
    ...
    func testObserveWeakWithOptions_ObserveNotInitialValue() {
        ...
        _ = root
            .rx.observeWeakly(\.string, options: .new)
            .subscribe(onNext: { n in
                latest = n as String?
            })
